...
from paint.MyDialog import MyDialog
...
class Painter:
    ...
    def setup_menubar(self):
        ...
        self.file_menu.add_command(label="choose color", accelerator='Shift+E', command=self.choose_color)
